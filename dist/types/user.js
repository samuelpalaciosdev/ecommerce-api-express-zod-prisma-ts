...
exports.updateUserPasswordSchema = zod_1.z.object({
    oldPassword: zod_1.z.string().min(8, { message: 'Please try again, your current password is at least 8 characters long' }),
    newPassword: zod_1.z.string().min(8, { message: 'Please provide a valid password with minimum 8 characters' }),
});
